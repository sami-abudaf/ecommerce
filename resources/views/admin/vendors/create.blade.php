                                            ...
                                            <div class="controls col-4">
                                                <fieldset class="form-group">
                                                    <div class="custom-file ">
                                                        <input type="file" name="logo" class="custom-file-input" id="inputGroupFile01" required="">
                                                        <label class="custom-file-label" for="inputGroupFile01">لوجو التجار </label>
                                                    </div>
...
<!------------------------------------>
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="categoryList" class="form-control selectBox bg-info white" name="category_id" required>
                                                            <option></option>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="subcategoryList" class="form-control selectBox bg-success white" name="subcategory_id" required disabled>
                                                            <option></option>
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="mobile"
                                                                   class="form-control"
                                                                   placeholder=" الهاتف " name="mobile" required>
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="pac-input"
                                                                   class="form-control"
                                                                   placeholder="من  فضلك  اكتب العنوان   "
                                            ...
                                            <div id="map" style="height: 1000px;width:auto;"></div>
...
<script>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDdhhhuGjK30fC4XyVauWELrgBFbXJ5Iq8&libraries=places&callback=initAutocomplete&language=ar&region=EG
         async defer"></script>
@stop
